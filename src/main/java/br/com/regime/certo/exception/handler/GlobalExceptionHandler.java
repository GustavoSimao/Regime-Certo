package br.com.regime.certo.exception.handler;


import br.com.regime.certo.exception.BusinessException;
import br.com.regime.certo.exception.ExceptionResponse;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> handleBusinessExceptions(Exception ex, WebRequest request) {
        ExceptionResponse response = new ExceptionResponse(
                new Date(),
                ex.getMessage(),
                request.getDescription(false));
